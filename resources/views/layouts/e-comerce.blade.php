                ...
                <nav class="navbar navbar-expand-md bg-dark navbar-dark">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto">
                            ...
                            <a href="'{{route('product_detail', 0)}}'" class="nav-item nav-link">Product Detail</a>
                            <a href="{{route('cart_page')}}" class="nav-item nav-link">Cart</a>
        ...
        <div class="bottom-bar">
            <div class="container-fluid">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-3">
                        <div class="user">
                            <a href="/store/wishlist-page" class="btn wishlist">
                                <i class="fa fa-heart"></i>
                                <span>(0)</span>
                            </a>
                            <a href="/store/cart-page" class="btn cart">
